  ...
  return (
    <div className="about">
      <div className="position1">
        ...
        <p>
          <span>Vår resa började i det välrenommerade bolaget Ovento AB,</span> där vi arbetade nära varandra och våra kunder
          under många år. När Ovento AB såldes till en större koncern följde vi med på tåget, men vi insåg snabbt att något
        ...
        <p>
          ...
          <span>fyra tidigare kollegor och numera delägare</span>, för att starta <span>Ovento Fukt AB</span>. Vi ville
          gå tillbaka till rötterna och bygga ett bolag där kunden alltid är i centrum, och där en överenskommelse
